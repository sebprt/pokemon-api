 ...
 */
final class Version20240821133831 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE answer (id INT NOT NULL, user_id UUID NOT NULL, question_id INT NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, is_correct BOOLEAN NOT NULL, answer_type VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE avatar (id INT NOT NULL, name VARCHAR(255) NOT NULL, unlock_points INT NOT NULL, is_unlock BOOLEAN DEFAULT false NOT NULL, url VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE choice (id INT NOT NULL, label VARCHAR(255) NOT NULL, is_correct BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE game_question (game_id UUID NOT NULL, question_id INT NOT NULL, PRIMARY KEY(game_id, question_id))');
        ...
        $this->addSql('CREATE TABLE game_session_answer (game_session_id INT NOT NULL, answer_id INT NOT NULL, PRIMARY KEY(game_session_id, answer_id))');
        ...
        $this->addSql('CREATE TABLE multiple_choice_answer (id INT NOT NULL, choice_id INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_5AF0920998666D1 ON multiple_choice_answer (choice_id)');
        $this->addSql('CREATE TABLE multiple_choice_question (id INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE multiple_choice_question_choice (multiple_choice_question_id INT NOT NULL, choice_id INT NOT NULL, PRIMARY KEY(multiple_choice_question_id, choice_id))');
        ...
        $this->addSql('CREATE TABLE question (id INT NOT NULL, label VARCHAR(255) NOT NULL, media VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE reward (id INT NOT NULL, name VARCHAR(255) NOT NULL, condition JSON NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE text_input_answer (id INT NOT NULL, content VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE text_input_question (id INT NOT NULL, correct_answer VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE user_user_reward (user_id UUID NOT NULL, user_reward_id INT NOT NULL, PRIMARY KEY(user_id, user_reward_id))');
        ...
        $this->addSql('CREATE TABLE user_user_avatar (user_id UUID NOT NULL, user_avatar_id INT NOT NULL, PRIMARY KEY(user_id, user_avatar_id))');
        ...
        $this->addSql('CREATE TABLE user_avatar (id INT NOT NULL, avatar_id INT NOT NULL, is_current BOOLEAN NOT NULL, unlocked_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE user_reward (id INT NOT NULL, reward_id INT NOT NULL, unlocked_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
